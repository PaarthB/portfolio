    ...
    return (
        <main>
            ...
            <section className="p-20 bg-gray-50 text-black font-serif">
                ...
                <p className="mb-4">
                    <br/><br/>An engineer based in Sydney, Australia 🌊 🌉, with a passion for bunch of things - sports ⚽ (swimming, basketball and soccer), surfing 🏄, travelling & cooking, with a rare taste into quality literature and art, and a genuine and warm person always 🤗.
