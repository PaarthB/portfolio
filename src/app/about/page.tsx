...
export default function About() {
    return (
        <main>
            <Navbar />
            <section className="p-20 bg-gray-50 text-black font-lato">
                ...
                <p className="mb-4">
                    <br/><br/>An <u>engineer</u> and a <u>surf life saver</u> based in <b>Sydney, Australia</b> 🌊 🌉, with a passion for bunch of things (including engineering!) - <b><i>sports</i></b> ⚽ (swimming, basketball and soccer), <b><i>surfing</i></b> 🏄, <b><i>travelling & cooking</i></b>, <b><i>cinematics & theatre (acting) 🎥 🎬</i></b>  with a rare sense of quality <b><i>literature and art</i></b>, and a genuine and warm person always 🤗.
                    <br/><br/>I am a problem solver at heart and love to help others (not limited to engineers!) in need. I thrive in a collaborative environment, and try to improve it with my resourcefulness and communication skills.
                    <br/><br/>
                </p>
                <h1 className="mb-8 text-2xl font-semibold tracking-tighter">Technical Skills 👨🏻‍💻</h1>
                <p className="mb-4">
                    I'm a <b>Full Stack Engineer</b> with a rare combination of skills in <u>DevOps / Site Reliability Engineering</u>, <u>Backend / Frontend</u>, <u>UX/UI</u> and <u>Mathematics</u>. <br/><br/>I have a keen eye to design sharp and performant user interfaces, and also backend apps {'</>'}. 
