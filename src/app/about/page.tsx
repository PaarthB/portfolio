    ...
    return (
        <main>
            ...
            <section className="p-20 bg-gray-50 text-black font-serif">
                ...
                <p className="mb-4">
                    <br/><br/>An engineer based in <b>Sydney, Australia</b> 🌊 🌉, with a passion for bunch of things - <b><i>sports</i></b> ⚽ (swimming, basketball and soccer), <b><i>surfing</i></b> 🏄, <b><i>travelling & cooking</i></b>, <b>cinematics 🎥 & theatre (acting) 🎬</b>  with a rare sense of quality <b><i>literature and art</i></b>, and a genuine and warm person always 🤗.
