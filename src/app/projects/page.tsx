            ...
            <section className="p-20">
                ...
                <ol className="relative border-s border-gray-200 dark:border-gray-700">                  
                    <li className="mb-10 ms-6">            
                        ...
                        <h3 className="flex items-center mb-1 text-lg font-semibold text-gray-900 dark:text-white">Founding Engineer - MapAI <span className="bg-blue-100 text-blue-800 text-sm font-medium me-2 px-2.5 py-0.5 rounded-sm dark:bg-blue-900 dark:text-blue-300 ms-3">Latest</span></h3>
                        <time className="block mb-2 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">May 2024 - June 2024</time>
                        <p className="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">Full stack application design with best-practices for geo-spatial analysis tools working with Data Scientists, Researchers & Business Leaders</p>
